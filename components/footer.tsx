          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              <a
                ...
                className="w-12 h-12 rounded-full bg-gradient-to-br from-[#C3DEEF] to-[#d4e5f0] flex items-center justify-center text-primary hover:shadow-lg hover:scale-110 transition-all shadow-[0_4px_0_0_rgba(0,0,0,0.2)]"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 rounded-full bg-gradient-to-br from-[#BCBF5E] to-[#c8cb73] flex items-center justify-center text-primary hover:shadow-lg hover:scale-110 transition-all shadow-[0_4px_0_0_rgba(0,0,0,0.2)]"
                aria-label="Behance"
              >
                <svg
              ...
              <a
                ...
                className="w-12 h-12 rounded-full bg-gradient-to-br from-[#E69D3B] to-[#eaad54] flex items-center justify-center text-primary hover:shadow-lg hover:scale-110 transition-all shadow-[0_4px_0_0_rgba(0,0,0,0.2)]"
                aria-label="Email"
              >
